...
public class ServiceClass : Entidad
{
    ...
    public int ejecutarSPTraeInt(string nombreSp, params object[] parametros)
    {
        int respuesta = 0;
        try
        {
            respuesta = Convert.ToInt32(this.EjecutarSP(nombreSp, parametros));
        }
        catch (Exception ex)
        {
    ...
    public void consultarToken()
    {
        ...
        try
        {
            dt = EjecutarSpDataTable("PARSELECTALL", null);
    ...
    public DataSet EjecutarSpDataSet(string nombreSp)
    {
        ...
        try
        {
            ds = this.EjecutarSpDataSet(nombreSp);
        }
        catch (Exception ex)
        {
            throw new Exception(ex.Message);
